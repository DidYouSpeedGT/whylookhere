...
for i in range(3):
    ...
    if (pwd == pasw):
        ...
        continue
time.sleep(2)
print("[0] Berhasil Login Menggunakan Akun iVannTR")
time.sleep(2)
...
print("------------------------------------------------")
print("Gada Rasa Kah Deck?")
print("[+] Toools Created By iVannTR")
print("[+] Use Tools iVannTRDos v3")
print("")
print("[+]Jangan lupa turu")
print("[+]attack website ON")
print("[+]attack GTPS ON")
print("[-]  || TCP || UDP || HTTP || DDOS || JETX || OVH || NTP")
print("------------------------------------------------")
